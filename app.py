...
#                 "Select the column containing the filenames:",
#                 df.columns,
#                 key="sort_col",
#             )
...
#             )
#             st.info(f"Found {len(target_files)} filenames listed in the selected column.")
...
#                     zip_buffer.seek(0)
#                     st.success(
#                         f"Processing complete. Found {len(matched_files)} matching pictures out of"
#                         f" {len(target_files)} target items."
#                     )

#                     st.download_button(
#                         label="📥 Download Separated Pictures (ZIP)",
#                         data=zip_buffer,
#                         file_name="matched_photos.zip",
...
#     st.write(
#         "Upload your photos or a ZIP archive, configure renaming rules, and download the renamed files."
#     )
...
#                 "Find text (e.g., w26):", placeholder="Text to replace"
#             )
#         with col2:
...
#                 "Remove from END (Suffix):", placeholder="e.g., -Copy"
#             )
...
#                     "Select Reference Name Column (e.g., SKU):",
#                     cols,
#                     key="img_ref_col",
#                 )
...
#     st.write(
#         "Upload your Excel file and images. Photos will be automatically resized to fit the fixed dimensions (**Height: 3.16 inches, Width: 2.07 inches**)."
#     )
...
#                 "Select Style Name Column (for matching):",
#                 cols_list,
#                 key="match_col_name",
#             )
#             photo_col = st.selectbox(
#                 "Select Photo Column (target column for insertion):",
#                 cols_list,
#                 key="photo_col_name",
#             )
...
#                             file_name="Catalog_With_Photos.xlsx",
...
# # ==========================================
# # MODE 5: TRANSFER PHOTOS BETWEEN EXCEL FILES
# # ==========================================
# elif app_mode == "🔄 Transfer Photos Between Excel Files":
#     st.header("🔄 Transfer Photos from One Excel to Another")
#     st.write(
#         "Transfer embedded photos from a Source Excel file to a Target Excel file by matching common field/column names."
#     )

#     source_excel = st.file_uploader(
#         "1. Upload SOURCE Excel (Containing Photos):", type=["xlsx"], key="src_excel"
#     )
#     target_excel = st.file_uploader(
#         "2. Upload TARGET Excel (To Receive Photos):", type=["xlsx"], key="tgt_excel"
#     )
...
#             st.success("Both Excel files successfully loaded.")

#             c1, c2 = st.columns(2)
#             with c1:
#                 src_match_col = st.selectbox("Source Style/Name Column:", src_headers, key="s_match")
#                 src_photo_col = st.selectbox("Source Photo Column:", src_headers, key="s_photo")
#             with c2:
#                 tgt_match_col = st.selectbox("Target Style/Name Column:", tgt_headers, key="t_match")
#                 tgt_photo_col = st.selectbox("Target Photo Column:", tgt_headers, key="t_photo")
